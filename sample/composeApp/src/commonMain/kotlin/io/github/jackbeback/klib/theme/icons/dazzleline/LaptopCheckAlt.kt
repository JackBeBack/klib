...
val DazzleLine.LaptopCheckAlt: ImageVector
    get() {
        if (_LaptopCheckAlt != null) {
            return _LaptopCheckAlt!!
        }
        _LaptopCheckAlt = ImageVector.Builder(
            name = "LaptopCheckAlt",
            defaultWidth = 800.dp,
...
private var _LaptopCheckAlt: ImageVector? = null
