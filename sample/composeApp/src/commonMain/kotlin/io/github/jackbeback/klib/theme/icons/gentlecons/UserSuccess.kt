...
val Gentlecons.UserSuccess: ImageVector
    get() {
        if (_UserSuccess != null) {
            return _UserSuccess!!
        }
        _UserSuccess = ImageVector.Builder(
            name = "UserSuccess",
            defaultWidth = 800.dp,
            ...
            path(fill = SolidColor(Color(0xFF0F0F0F))) {
                ...
                curveTo(18.035f, 20.49f, 17.937f, 20.557f, 17.832f, 20.606f)
...
private var _UserSuccess: ImageVector? = null
