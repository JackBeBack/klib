...
val DazzleLine.MailOpenMinus: ImageVector
    get() {
        if (_MailOpenMinus != null) {
            return _MailOpenMinus!!
        }
        _MailOpenMinus = ImageVector.Builder(
            name = "MailOpenMinus",
            defaultWidth = 800.dp,
...
private var _MailOpenMinus: ImageVector? = null
