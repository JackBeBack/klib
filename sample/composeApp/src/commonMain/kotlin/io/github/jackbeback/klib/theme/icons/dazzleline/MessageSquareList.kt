...
val DazzleLine.MessageSquareList: ImageVector
    get() {
        if (_MessageSquareList != null) {
            return _MessageSquareList!!
        }
        _MessageSquareList = ImageVector.Builder(
            name = "MessageSquareList",
            defaultWidth = 800.dp,
...
private var _MessageSquareList: ImageVector? = null
