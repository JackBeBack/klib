...
val DazzleLine.InboxInformation: ImageVector
    get() {
        if (_InboxInformation != null) {
            return _InboxInformation!!
        }
        _InboxInformation = ImageVector.Builder(
            name = "InboxInformation",
            defaultWidth = 800.dp,
...
private var _InboxInformation: ImageVector? = null
