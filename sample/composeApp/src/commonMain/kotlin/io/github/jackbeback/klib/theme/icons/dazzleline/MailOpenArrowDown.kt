...
val DazzleLine.MailOpenArrowDown: ImageVector
    get() {
        if (_MailOpenArrowDown != null) {
            return _MailOpenArrowDown!!
        }
        _MailOpenArrowDown = ImageVector.Builder(
            name = "MailOpenArrowDown",
            defaultWidth = 800.dp,
...
private var _MailOpenArrowDown: ImageVector? = null
