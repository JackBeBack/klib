...
val DazzleLine.MailOpenAlt: ImageVector
    get() {
        if (_MailOpenAlt != null) {
            return _MailOpenAlt!!
        }
        _MailOpenAlt = ImageVector.Builder(
            name = "MailOpenAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                curveTo(3.951f, 8.055f, 3.678f, 8.226f, 3.479f, 8.459f)
                curveTo(3.304f, 8.664f, 3.172f, 8.903f, 3.091f, 9.161f)
                curveTo(3f, 9.452f, 3f, 9.775f, 3f, 10.421f)
                ...
                curveTo(21f, 9.775f, 21f, 9.452f, 20.909f, 9.161f)
                curveTo(20.828f, 8.903f, 20.696f, 8.664f, 20.521f, 8.459f)
                curveTo(20.322f, 8.226f, 20.049f, 8.055f, 19.502f, 7.711f)
...
private var _MailOpenAlt: ImageVector? = null
