...
val DazzleLine.MessageSquareExclamation: ImageVector
    get() {
        if (_MessageSquareExclamation != null) {
            return _MessageSquareExclamation!!
        }
        _MessageSquareExclamation = ImageVector.Builder(
            name = "MessageSquareExclamation",
            defaultWidth = 800.dp,
...
private var _MessageSquareExclamation: ImageVector? = null
