...
val DazzleLine.FileHeartAlt: ImageVector
    get() {
        if (_FileHeartAlt != null) {
            return _FileHeartAlt!!
        }
        _FileHeartAlt = ImageVector.Builder(
            name = "FileHeartAlt",
            defaultWidth = 800.dp,
...
private var _FileHeartAlt: ImageVector? = null
