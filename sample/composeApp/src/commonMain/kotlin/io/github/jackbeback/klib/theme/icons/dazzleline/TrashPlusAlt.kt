...
val DazzleLine.TrashPlusAlt: ImageVector
    get() {
        if (_TrashPlusAlt != null) {
            return _TrashPlusAlt!!
        }
        _TrashPlusAlt = ImageVector.Builder(
            name = "TrashPlusAlt",
            defaultWidth = 800.dp,
...
private var _TrashPlusAlt: ImageVector? = null
