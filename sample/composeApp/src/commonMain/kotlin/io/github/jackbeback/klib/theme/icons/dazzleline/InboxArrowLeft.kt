...
val DazzleLine.InboxArrowLeft: ImageVector
    get() {
        if (_InboxArrowLeft != null) {
            return _InboxArrowLeft!!
        }
        _InboxArrowLeft = ImageVector.Builder(
            name = "InboxArrowLeft",
            defaultWidth = 800.dp,
...
private var _InboxArrowLeft: ImageVector? = null
