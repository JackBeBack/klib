...
val DazzleLine.MessageSquareMedical: ImageVector
    get() {
        if (_MessageSquareMedical != null) {
            return _MessageSquareMedical!!
        }
        _MessageSquareMedical = ImageVector.Builder(
            name = "MessageSquareMedical",
            defaultWidth = 800.dp,
...
private var _MessageSquareMedical: ImageVector? = null
