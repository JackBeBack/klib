...
val DazzleLine.ToiletPaperDots: ImageVector
    get() {
        if (_ToiletPaperDots != null) {
            return _ToiletPaperDots!!
        }
        _ToiletPaperDots = ImageVector.Builder(
            name = "ToiletPaperDots",
            defaultWidth = 800.dp,
...
private var _ToiletPaperDots: ImageVector? = null
