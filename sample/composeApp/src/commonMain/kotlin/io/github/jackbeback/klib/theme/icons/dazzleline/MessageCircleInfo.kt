...
val DazzleLine.MessageCircleInfo: ImageVector
    get() {
        if (_MessageCircleInfo != null) {
            return _MessageCircleInfo!!
        }
        _MessageCircleInfo = ImageVector.Builder(
            name = "MessageCircleInfo",
            defaultWidth = 800.dp,
...
private var _MessageCircleInfo: ImageVector? = null
