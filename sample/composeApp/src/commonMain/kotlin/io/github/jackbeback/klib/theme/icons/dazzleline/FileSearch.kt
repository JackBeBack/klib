...
val DazzleLine.FileSearch: ImageVector
    get() {
        if (_FileSearch != null) {
            return _FileSearch!!
        }
        _FileSearch = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(14f, 14.5f)
                curveTo(14f, 15.881f, 12.881f, 17f, 11.5f, 17f)
                curveTo(10.119f, 17f, 9f, 15.881f, 9f, 14.5f)
                curveTo(9f, 13.119f, 10.119f, 12f, 11.5f, 12f)
                curveTo(12.881f, 12f, 14f, 13.119f, 14f, 14.5f)
                close()
            }
        }.build()
