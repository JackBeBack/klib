...
val DazzleLine.GridSearch: ImageVector
    get() {
        if (_GridSearch != null) {
            return _GridSearch!!
        }
        _GridSearch = ImageVector.Builder(
            name = "GridSearch",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(20f, 20f)
                lineTo(18.268f, 18.268f)
                moveTo(18.268f, 18.268f)
                curveTo(18.72f, 17.815f, 19f, 17.19f, 19f, 16.5f)
                ...
                curveTo(17.19f, 19f, 17.815f, 18.72f, 18.268f, 18.268f)
                close()
                moveTo(15.6f, 10f)
...
private var _GridSearch: ImageVector? = null
