...
val DazzleLine.MessageSquareLines: ImageVector
    get() {
        if (_MessageSquareLines != null) {
            return _MessageSquareLines!!
        }
        _MessageSquareLines = ImageVector.Builder(
...
private var _MessageSquareLines: ImageVector? = null
