...
val DazzleLine.ClipboardXmark: ImageVector
    get() {
        if (_ClipboardXmark != null) {
            return _ClipboardXmark!!
        }
        _ClipboardXmark = ImageVector.Builder(
            name = "ClipboardXmark",
            defaultWidth = 800.dp,
...
private var _ClipboardXmark: ImageVector? = null
