...
val DazzleLine.CalendarExclamationAlt: ImageVector
    get() {
        if (_CalendarExclamationAlt != null) {
            return _CalendarExclamationAlt!!
        }
        _CalendarExclamationAlt = ImageVector.Builder(
            name = "CalendarExclamationAlt",
            defaultWidth = 800.dp,
...
private var _CalendarExclamationAlt: ImageVector? = null
