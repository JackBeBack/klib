...
val DazzleLine.DiamondTurnRight: ImageVector
    get() {
        if (_DiamondTurnRight != null) {
            return _DiamondTurnRight!!
        }
        _DiamondTurnRight = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(15f, 12f)
                lineTo(13f, 14f)
                moveTo(14.262f, 19.737f)
                lineTo(19.737f, 14.263f)
                curveTo(20.529f, 13.471f, 20.925f, 13.075f, 21.073f, 12.618f)
                curveTo(21.204f, 12.216f, 21.204f, 11.784f, 21.073f, 11.382f)
                curveTo(20.925f, 10.925f, 20.529f, 10.529f, 19.737f, 9.737f)
                ...
                lineTo(4.262f, 9.737f)
                curveTo(3.47f, 10.529f, 3.074f, 10.925f, 2.926f, 11.382f)
                curveTo(2.796f, 11.784f, 2.796f, 12.216f, 2.926f, 12.618f)
                curveTo(3.074f, 13.075f, 3.47f, 13.471f, 4.262f, 14.263f)
