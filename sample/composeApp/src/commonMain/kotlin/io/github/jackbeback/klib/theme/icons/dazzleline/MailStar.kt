...
val DazzleLine.MailStar: ImageVector
    get() {
        if (_MailStar != null) {
            return _MailStar!!
        }
        _MailStar = ImageVector.Builder(
            name = "MailStar",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(18f, 13.5f)
                lineTo(19.411f, 15.558f)
                lineTo(21.804f, 16.264f)
                lineTo(20.282f, 18.242f)
                lineTo(20.351f, 20.736f)
                lineTo(18f, 19.9f)
                lineTo(15.649f, 20.736f)
                lineTo(15.717f, 18.242f)
                lineTo(14.196f, 16.264f)
                lineTo(16.589f, 15.558f)
                lineTo(18f, 13.5f)
                close()
            }
        }.build()
