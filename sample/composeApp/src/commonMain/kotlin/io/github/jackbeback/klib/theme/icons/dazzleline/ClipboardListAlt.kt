...
val DazzleLine.ClipboardListAlt: ImageVector
    get() {
        if (_ClipboardListAlt != null) {
            return _ClipboardListAlt!!
        }
        _ClipboardListAlt = ImageVector.Builder(
            name = "ClipboardListAlt",
            defaultWidth = 800.dp,
...
private var _ClipboardListAlt: ImageVector? = null
