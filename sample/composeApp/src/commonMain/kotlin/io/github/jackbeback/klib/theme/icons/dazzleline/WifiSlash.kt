...
val DazzleLine.WifiSlash: ImageVector
    get() {
        if (_WifiSlash != null) {
            return _WifiSlash!!
        }
        _WifiSlash = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF000000))) {
                ...
                lineTo(4.6f, 11.861f)
                close()
                moveTo(10.571f, 4.063f)
                curveTo(10.02f, 4.112f, 9.614f, 4.597f, 9.663f, 5.147f)
                curveTo(9.711f, 5.698f, 10.197f, 6.104f, 10.747f, 6.055f)
                lineTo(10.571f, 4.063f)
                close()
                moveTo(17.339f, 10.38f)
                curveTo(16.857f, 10.111f, 16.248f, 10.285f, 15.979f, 10.768f)
                curveTo(15.711f, 11.25f, 15.885f, 11.859f, 16.367f, 12.128f)
                lineTo(17.339f, 10.38f)
                close()
                ...
                close()
                moveTo(10.747f, 6.055f)
                curveTo(11.16f, 6.019f, 11.578f, 6f, 12f, 6f)
                verticalLineTo(4f)
                curveTo(11.519f, 4f, 11.042f, 4.021f, 10.571f, 4.063f)
                lineTo(10.747f, 6.055f)
                close()
                moveTo(16.367f, 12.128f)
                curveTo(16.976f, 12.466f, 17.541f, 12.874f, 18.054f, 13.34f)
                lineTo(19.4f, 11.861f)
                curveTo(18.775f, 11.293f, 18.084f, 10.794f, 17.339f, 10.38f)
                lineTo(16.367f, 12.128f)
                close()
                moveTo(2.293f, 3.707f)
                lineTo(5.466f, 6.881f)
                lineTo(6.881f, 5.466f)
                lineTo(3.707f, 2.293f)
                lineTo(2.293f, 3.707f)
                close()
                moveTo(2.667f, 9.565f)
                curveTo(3.812f, 8.54f, 5.126f, 7.701f, 6.562f, 7.095f)
                lineTo(5.785f, 5.252f)
                curveTo(4.143f, 5.945f, 2.641f, 6.904f, 1.333f, 8.074f)
                lineTo(2.667f, 9.565f)
                close()
                moveTo(5.466f, 6.881f)
                lineTo(9.46f, 10.875f)
                lineTo(10.875f, 9.46f)
                lineTo(6.881f, 5.466f)
                lineTo(5.466f, 6.881f)
                close()
                moveTo(9.46f, 10.875f)
                lineTo(20.293f, 21.707f)
                ...
                curveTo(7.159f, 12.237f, 8.674f, 11.461f, 10.35f, 11.151f)
                lineTo(9.985f, 9.184f)
                curveTo(7.933f, 9.564f, 6.081f, 10.514f, 4.6f, 11.861f)
