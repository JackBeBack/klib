...
val DazzleLine.ImageSquareXmark: ImageVector
    get() {
        if (_ImageSquareXmark != null) {
            return _ImageSquareXmark!!
        }
        _ImageSquareXmark = ImageVector.Builder(
            name = "ImageSquareXmark",
            defaultWidth = 800.dp,
...
private var _ImageSquareXmark: ImageVector? = null
