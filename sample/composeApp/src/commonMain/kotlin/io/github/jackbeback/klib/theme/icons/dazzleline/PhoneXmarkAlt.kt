...
val DazzleLine.PhoneXmarkAlt: ImageVector
    get() {
        if (_PhoneXmarkAlt != null) {
            return _PhoneXmarkAlt!!
        }
        _PhoneXmarkAlt = ImageVector.Builder(
            name = "PhoneXmarkAlt",
            defaultWidth = 800.dp,
...
private var _PhoneXmarkAlt: ImageVector? = null
