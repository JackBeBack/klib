...
val DazzleLine.MessageCircleMedical: ImageVector
    get() {
        if (_MessageCircleMedical != null) {
            return _MessageCircleMedical!!
        }
        _MessageCircleMedical = ImageVector.Builder(
            name = "MessageCircleMedical",
            defaultWidth = 800.dp,
...
private var _MessageCircleMedical: ImageVector? = null
