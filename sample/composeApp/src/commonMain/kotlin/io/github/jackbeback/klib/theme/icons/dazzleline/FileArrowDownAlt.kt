...
val DazzleLine.FileArrowDownAlt: ImageVector
    get() {
        if (_FileArrowDownAlt != null) {
            return _FileArrowDownAlt!!
        }
        _FileArrowDownAlt = ImageVector.Builder(
            name = "FileArrowDownAlt",
            defaultWidth = 800.dp,
...
private var _FileArrowDownAlt: ImageVector? = null
