...
val DazzleLine.TemperatureQuarter: ImageVector
    get() {
        if (_TemperatureQuarter != null) {
            return _TemperatureQuarter!!
        }
        _TemperatureQuarter = ImageVector.Builder(
...
private var _TemperatureQuarter: ImageVector? = null
