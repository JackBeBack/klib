...
val DazzleLine.MessageSquareArrowUp: ImageVector
    get() {
        if (_MessageSquareArrowUp != null) {
            return _MessageSquareArrowUp!!
        }
        _MessageSquareArrowUp = ImageVector.Builder(
            name = "MessageSquareArrowUp",
            defaultWidth = 800.dp,
...
private var _MessageSquareArrowUp: ImageVector? = null
