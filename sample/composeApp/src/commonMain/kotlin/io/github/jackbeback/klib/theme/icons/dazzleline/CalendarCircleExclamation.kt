...
val DazzleLine.CalendarCircleExclamation: ImageVector
    get() {
        if (_CalendarCircleExclamation != null) {
            return _CalendarCircleExclamation!!
        }
        _CalendarCircleExclamation = ImageVector.Builder(
            name = "CalendarCircleExclamation",
            defaultWidth = 800.dp,
...
private var _CalendarCircleExclamation: ImageVector? = null
