...
val DazzleLine.LaptopShieldAlt: ImageVector
    get() {
        if (_LaptopShieldAlt != null) {
            return _LaptopShieldAlt!!
        }
        _LaptopShieldAlt = ImageVector.Builder(
            name = "LaptopShieldAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                verticalLineTo(14f)
                moveTo(9f, 4.167f)
                curveTo(9f, 4.167f, 8.694f, 4.167f, 8.625f, 4.167f)
                curveTo(7.601f, 4.167f, 6.708f, 3.752f, 6f, 3f)
                curveTo(5.292f, 3.752f, 4.399f, 4.167f, 3.375f, 4.167f)
                curveTo(3.306f, 4.167f, 3f, 4.167f, 3f, 4.167f)
                curveTo(3f, 4.167f, 3f, 4.944f, 3f, 5.398f)
                curveTo(3f, 7.612f, 4.275f, 9.472f, 6f, 10f)
                curveTo(7.725f, 9.472f, 9f, 7.612f, 9f, 5.398f)
                curveTo(9f, 4.944f, 9f, 4.167f, 9f, 4.167f)
                close()
                moveTo(22f, 16f)
...
private var _LaptopShieldAlt: ImageVector? = null
