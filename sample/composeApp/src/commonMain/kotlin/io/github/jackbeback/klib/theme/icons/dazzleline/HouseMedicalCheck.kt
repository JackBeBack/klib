...
val DazzleLine.HouseMedicalCheck: ImageVector
    get() {
        if (_HouseMedicalCheck != null) {
            return _HouseMedicalCheck!!
        }
        _HouseMedicalCheck = ImageVector.Builder(
            name = "HouseMedicalCheck",
            defaultWidth = 800.dp,
...
private var _HouseMedicalCheck: ImageVector? = null
