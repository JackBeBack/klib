...
val DazzleLine.FileBlockAlt: ImageVector
    get() {
        if (_FileBlockAlt != null) {
            return _FileBlockAlt!!
        }
        _FileBlockAlt = ImageVector.Builder(
            name = "FileBlockAlt",
            defaultWidth = 800.dp,
...
private var _FileBlockAlt: ImageVector? = null
