...
val DazzleLine.InboxExclamation: ImageVector
    get() {
        if (_InboxExclamation != null) {
            return _InboxExclamation!!
        }
        _InboxExclamation = ImageVector.Builder(
            name = "InboxExclamation",
            defaultWidth = 800.dp,
...
private var _InboxExclamation: ImageVector? = null
