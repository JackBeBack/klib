...
val DazzleLine.FileSearchAlt: ImageVector
    get() {
        if (_FileSearchAlt != null) {
            return _FileSearchAlt!!
        }
        _FileSearchAlt = ImageVector.Builder(
            name = "FileSearchAlt",
            defaultWidth = 800.dp,
...
private var _FileSearchAlt: ImageVector? = null
