...
val DazzleLine.MailRefresh: ImageVector
    get() {
        if (_MailRefresh != null) {
            return _MailRefresh!!
        }
        _MailRefresh = ImageVector.Builder(
            name = "MailRefresh",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(20.5f, 19.736f)
                curveTo(19.969f, 20.211f, 19.268f, 20.5f, 18.5f, 20.5f)
                curveTo(16.843f, 20.5f, 15.5f, 19.157f, 15.5f, 17.5f)
                curveTo(15.5f, 15.843f, 16.843f, 14.5f, 18.5f, 14.5f)
                curveTo(19.806f, 14.5f, 20.917f, 15.335f, 21.329f, 16.5f)
                moveTo(22f, 14f)
                verticalLineTo(17f)
...
private var _MailRefresh: ImageVector? = null
