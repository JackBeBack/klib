...
val DazzleLine.MailAlt: ImageVector
    get() {
        if (_MailAlt != null) {
            return _MailAlt!!
        }
        _MailAlt = ImageVector.Builder(
            name = "MailAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                lineTo(15f, 12f)
                moveTo(3f, 8f)
                lineTo(10.225f, 12.817f)
                curveTo(10.866f, 13.244f, 11.187f, 13.458f, 11.534f, 13.541f)
                curveTo(11.84f, 13.615f, 12.16f, 13.615f, 12.466f, 13.541f)
                curveTo(12.813f, 13.458f, 13.134f, 13.244f, 13.775f, 12.817f)
                lineTo(21f, 8f)
                moveTo(6.2f, 19f)
...
private var _MailAlt: ImageVector? = null
