...
val DazzleLine.SquareDotsVertical: ImageVector
    get() {
        if (_SquareDotsVertical != null) {
            return _SquareDotsVertical!!
        }
        _SquareDotsVertical = ImageVector.Builder(
            name = "SquareDotsVertical",
            defaultWidth = 800.dp,
...
private var _SquareDotsVertical: ImageVector? = null
