...
val Gentlecons.CallReceive: ImageVector
    get() {
        if (_CallReceive != null) {
            return _CallReceive!!
        }
        _CallReceive = ImageVector.Builder(
            name = "CallReceive",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                curveTo(12.273f, 18.545f, 16.036f, 19.84f, 17.84f, 20.292f)
                curveTo(18.104f, 20.358f, 18.423f, 20.256f, 18.642f, 19.949f)
...
private var _CallReceive: ImageVector? = null
