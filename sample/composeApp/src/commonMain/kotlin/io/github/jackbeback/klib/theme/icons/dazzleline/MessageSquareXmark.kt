...
val DazzleLine.MessageSquareXmark: ImageVector
    get() {
        if (_MessageSquareXmark != null) {
            return _MessageSquareXmark!!
        }
        _MessageSquareXmark = ImageVector.Builder(
            name = "MessageSquareXmark",
            defaultWidth = 800.dp,
...
private var _MessageSquareXmark: ImageVector? = null
