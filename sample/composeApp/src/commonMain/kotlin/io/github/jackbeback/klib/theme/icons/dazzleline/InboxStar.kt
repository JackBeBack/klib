...
val DazzleLine.InboxStar: ImageVector
    get() {
        if (_InboxStar != null) {
            return _InboxStar!!
        }
        _InboxStar = ImageVector.Builder(
            name = "InboxStar",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(12f, 7f)
                lineTo(13.058f, 8.544f)
                lineTo(14.853f, 9.073f)
                lineTo(13.712f, 10.556f)
                lineTo(13.763f, 12.427f)
                lineTo(12f, 11.8f)
                lineTo(10.236f, 12.427f)
                lineTo(10.288f, 10.556f)
                lineTo(9.146f, 9.073f)
                lineTo(10.942f, 8.544f)
                lineTo(12f, 7f)
                close()
                moveTo(7.2f, 4f)
...
private var _InboxStar: ImageVector? = null
