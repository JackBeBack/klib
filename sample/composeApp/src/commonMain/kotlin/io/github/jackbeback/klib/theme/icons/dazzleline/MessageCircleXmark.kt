...
val DazzleLine.MessageCircleXmark: ImageVector
    get() {
        if (_MessageCircleXmark != null) {
            return _MessageCircleXmark!!
        }
        _MessageCircleXmark = ImageVector.Builder(
            name = "MessageCircleXmark",
            defaultWidth = 800.dp,
...
private var _MessageCircleXmark: ImageVector? = null
