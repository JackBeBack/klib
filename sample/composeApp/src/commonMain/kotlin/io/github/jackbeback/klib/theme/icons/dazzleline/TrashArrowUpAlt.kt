...
val DazzleLine.TrashArrowUpAlt: ImageVector
    get() {
        if (_TrashArrowUpAlt != null) {
            return _TrashArrowUpAlt!!
        }
        _TrashArrowUpAlt = ImageVector.Builder(
            name = "TrashArrowUpAlt",
            defaultWidth = 800.dp,
...
private var _TrashArrowUpAlt: ImageVector? = null
