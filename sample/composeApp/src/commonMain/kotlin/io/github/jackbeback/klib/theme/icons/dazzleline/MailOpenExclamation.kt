...
val DazzleLine.MailOpenExclamation: ImageVector
    get() {
        if (_MailOpenExclamation != null) {
            return _MailOpenExclamation!!
        }
        _MailOpenExclamation = ImageVector.Builder(
            name = "MailOpenExclamation",
            defaultWidth = 800.dp,
...
private var _MailOpenExclamation: ImageVector? = null
