...
val DazzleLine.PhoneSlash: ImageVector
    get() {
        if (_PhoneSlash != null) {
            return _PhoneSlash!!
        }
        _PhoneSlash = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(15.779f, 21f, 13.222f, 20.299f, 11f, 19.068f)
                moveTo(7.538f, 16.462f)
                curveTo(4.757f, 13.66f, 3f, 9.76f, 3f, 5.5f)
                ...
                lineTo(8f, 10f)
                curveTo(8.592f, 11.306f, 9.46f, 12.531f, 10.459f, 13.541f)
            }
        }.build()
