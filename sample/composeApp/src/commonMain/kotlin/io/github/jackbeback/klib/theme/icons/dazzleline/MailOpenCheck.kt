...
val DazzleLine.MailOpenCheck: ImageVector
    get() {
        if (_MailOpenCheck != null) {
            return _MailOpenCheck!!
        }
        _MailOpenCheck = ImageVector.Builder(
            name = "MailOpenCheck",
            defaultWidth = 800.dp,
...
private var _MailOpenCheck: ImageVector? = null
