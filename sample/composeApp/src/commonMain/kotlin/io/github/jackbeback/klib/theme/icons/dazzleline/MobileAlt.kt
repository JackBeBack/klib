...
val DazzleLine.MobileAlt: ImageVector
    get() {
        if (_MobileAlt != null) {
            return _MobileAlt!!
        }
        _MobileAlt = ImageVector.Builder(
            name = "MobileAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(10f, 3f)
                verticalLineTo(4.4f)
                curveTo(10f, 4.96f, 10f, 5.24f, 10.109f, 5.454f)
                curveTo(10.205f, 5.642f, 10.358f, 5.795f, 10.546f, 5.891f)
                curveTo(10.76f, 6f, 11.04f, 6f, 11.6f, 6f)
                horizontalLineTo(12.4f)
                curveTo(12.96f, 6f, 13.24f, 6f, 13.454f, 5.891f)
                curveTo(13.642f, 5.795f, 13.795f, 5.642f, 13.891f, 5.454f)
                curveTo(14f, 5.24f, 14f, 4.96f, 14f, 4.4f)
                verticalLineTo(3f)
                moveTo(9.2f, 21f)
...
private var _MobileAlt: ImageVector? = null
