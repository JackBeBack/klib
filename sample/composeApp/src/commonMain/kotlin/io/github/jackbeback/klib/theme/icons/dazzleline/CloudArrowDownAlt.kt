...
val DazzleLine.CloudArrowDownAlt: ImageVector
    get() {
        if (_CloudArrowDownAlt != null) {
            return _CloudArrowDownAlt!!
        }
        _CloudArrowDownAlt = ImageVector.Builder(
            name = "CloudArrowDownAlt",
            defaultWidth = 800.dp,
...
private var _CloudArrowDownAlt: ImageVector? = null
