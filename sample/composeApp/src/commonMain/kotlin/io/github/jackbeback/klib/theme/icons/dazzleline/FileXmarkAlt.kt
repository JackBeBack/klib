...
val DazzleLine.FileXmarkAlt: ImageVector
    get() {
        if (_FileXmarkAlt != null) {
            return _FileXmarkAlt!!
        }
        _FileXmarkAlt = ImageVector.Builder(
            name = "FileXmarkAlt",
            defaultWidth = 800.dp,
...
private var _FileXmarkAlt: ImageVector? = null
