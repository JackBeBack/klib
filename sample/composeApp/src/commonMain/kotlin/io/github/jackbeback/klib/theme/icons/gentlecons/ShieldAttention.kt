...
val Gentlecons.ShieldAttention: ImageVector
    get() {
        if (_ShieldAttention != null) {
            return _ShieldAttention!!
        }
        _ShieldAttention = ImageVector.Builder(
...
private var _ShieldAttention: ImageVector? = null
