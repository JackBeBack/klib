...
val DazzleLine.WaterArrowDown: ImageVector
    get() {
        if (_WaterArrowDown != null) {
            return _WaterArrowDown!!
        }
        _WaterArrowDown = ImageVector.Builder(
            name = "WaterArrowDown",
            defaultWidth = 800.dp,
...
private var _WaterArrowDown: ImageVector? = null
