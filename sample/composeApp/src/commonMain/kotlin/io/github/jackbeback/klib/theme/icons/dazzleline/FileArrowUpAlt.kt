...
val DazzleLine.FileArrowUpAlt: ImageVector
    get() {
        if (_FileArrowUpAlt != null) {
            return _FileArrowUpAlt!!
        }
        _FileArrowUpAlt = ImageVector.Builder(
            name = "FileArrowUpAlt",
            defaultWidth = 800.dp,
...
private var _FileArrowUpAlt: ImageVector? = null
