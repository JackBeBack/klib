...
val DazzleLine.DistributeSpacingVerticalAlt: ImageVector
    get() {
        if (_DistributeSpacingVerticalAlt != null) {
            return _DistributeSpacingVerticalAlt!!
        }
        _DistributeSpacingVerticalAlt = ImageVector.Builder(
            name = "DistributeSpacingVerticalAlt",
            defaultWidth = 800.dp,
...
private var _DistributeSpacingVerticalAlt: ImageVector? = null
