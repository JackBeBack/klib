...
val DazzleLine.ClipboardArrowDown: ImageVector
    get() {
        if (_ClipboardArrowDown != null) {
            return _ClipboardArrowDown!!
        }
        _ClipboardArrowDown = ImageVector.Builder(
            name = "ClipboardArrowDown",
            defaultWidth = 800.dp,
...
private var _ClipboardArrowDown: ImageVector? = null
