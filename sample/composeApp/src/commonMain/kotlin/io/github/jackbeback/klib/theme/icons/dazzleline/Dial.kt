...
val DazzleLine.Dial: ImageVector
    get() {
        if (_Dial != null) {
            return _Dial!!
        }
        _Dial = ImageVector.Builder(
            name = "Dial",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(12f, 13f)
                lineTo(14.828f, 10.172f)
                moveTo(14.828f, 10.172f)
                curveTo(14.105f, 9.448f, 13.105f, 9f, 12f, 9f)
                curveTo(9.791f, 9f, 8f, 10.791f, 8f, 13f)
                curveTo(8f, 15.209f, 9.791f, 17f, 12f, 17f)
                curveTo(14.209f, 17f, 16f, 15.209f, 16f, 13f)
                curveTo(16f, 11.895f, 15.552f, 10.895f, 14.828f, 10.172f)
                close()
                moveTo(3.5f, 13f)
