...
val DazzleLine.MessageSquareLinesAlt: ImageVector
    get() {
        if (_MessageSquareLinesAlt != null) {
            return _MessageSquareLinesAlt!!
        }
        _MessageSquareLinesAlt = ImageVector.Builder(
            name = "MessageSquareLinesAlt",
            defaultWidth = 800.dp,
...
private var _MessageSquareLinesAlt: ImageVector? = null
