...
val DazzleLine.HouseChimneyFloor: ImageVector
    get() {
        if (_HouseChimneyFloor != null) {
            return _HouseChimneyFloor!!
        }
        _HouseChimneyFloor = ImageVector.Builder(
            name = "HouseChimneyFloor",
            defaultWidth = 800.dp,
...
private var _HouseChimneyFloor: ImageVector? = null
