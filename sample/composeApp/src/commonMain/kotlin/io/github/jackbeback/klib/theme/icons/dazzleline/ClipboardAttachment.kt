...
val DazzleLine.ClipboardAttachment: ImageVector
    get() {
        if (_ClipboardAttachment != null) {
            return _ClipboardAttachment!!
        }
        _ClipboardAttachment = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(12f, 15.5f)
                verticalLineTo(11f)
                curveTo(12f, 10.172f, 12.672f, 9.5f, 13.5f, 9.5f)
                curveTo(14.328f, 9.5f, 15f, 10.172f, 15f, 11f)
                verticalLineTo(15.5f)
                curveTo(15f, 17.157f, 13.657f, 18.5f, 12f, 18.5f)
                curveTo(10.343f, 18.5f, 9f, 17.157f, 9f, 15.5f)
...
private var _ClipboardAttachment: ImageVector? = null
