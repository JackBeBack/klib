...
val DazzleLine.TrashXmarkAlt: ImageVector
    get() {
        if (_TrashXmarkAlt != null) {
            return _TrashXmarkAlt!!
        }
        _TrashXmarkAlt = ImageVector.Builder(
            name = "TrashXmarkAlt",
            defaultWidth = 800.dp,
...
private var _TrashXmarkAlt: ImageVector? = null
