...
val DazzleLine.SquareDazzle: ImageVector
    get() {
        if (_SquareDazzle != null) {
            return _SquareDazzle!!
        }
        _SquareDazzle = ImageVector.Builder(
            name = "SquareDazzle",
            defaultWidth = 800.dp,
...
private var _SquareDazzle: ImageVector? = null
