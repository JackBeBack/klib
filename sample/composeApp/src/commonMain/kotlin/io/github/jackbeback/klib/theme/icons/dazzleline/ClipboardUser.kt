...
val DazzleLine.ClipboardUser: ImageVector
    get() {
        if (_ClipboardUser != null) {
            return _ClipboardUser!!
        }
        _ClipboardUser = ImageVector.Builder(
            name = "ClipboardUser",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                verticalLineTo(5f)
                moveTo(15f, 18f)
                curveTo(14.716f, 16.859f, 13.481f, 16f, 12f, 16f)
                curveTo(10.519f, 16f, 9.284f, 16.859f, 9f, 18f)
                moveTo(12f, 12f)
