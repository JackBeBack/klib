...
val DazzleLine.MailOpenPlus: ImageVector
    get() {
        if (_MailOpenPlus != null) {
            return _MailOpenPlus!!
        }
        _MailOpenPlus = ImageVector.Builder(
            name = "MailOpenPlus",
            defaultWidth = 800.dp,
...
private var _MailOpenPlus: ImageVector? = null
