...
val DazzleLine.SquareExclamation: ImageVector
    get() {
        if (_SquareExclamation != null) {
            return _SquareExclamation!!
        }
        _SquareExclamation = ImageVector.Builder(
            name = "SquareExclamation",
            defaultWidth = 800.dp,
