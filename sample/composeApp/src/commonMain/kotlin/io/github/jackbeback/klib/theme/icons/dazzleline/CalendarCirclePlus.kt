...
val DazzleLine.CalendarCirclePlus: ImageVector
    get() {
        if (_CalendarCirclePlus != null) {
            return _CalendarCirclePlus!!
        }
        _CalendarCirclePlus = ImageVector.Builder(
            name = "CalendarCirclePlus",
            defaultWidth = 800.dp,
...
private var _CalendarCirclePlus: ImageVector? = null
