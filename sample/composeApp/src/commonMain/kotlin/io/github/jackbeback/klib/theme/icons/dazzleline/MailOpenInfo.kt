...
val DazzleLine.MailOpenInfo: ImageVector
    get() {
        if (_MailOpenInfo != null) {
            return _MailOpenInfo!!
        }
        _MailOpenInfo = ImageVector.Builder(
            name = "MailOpenInfo",
            defaultWidth = 800.dp,
...
private var _MailOpenInfo: ImageVector? = null
