...
val DazzleLine.MessageSquareBlock: ImageVector
    get() {
        if (_MessageSquareBlock != null) {
            return _MessageSquareBlock!!
        }
        _MessageSquareBlock = ImageVector.Builder(
            name = "MessageSquareBlock",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                lineTo(14f, 9f)
                moveTo(15f, 11f)
                curveTo(15f, 12.657f, 13.657f, 14f, 12f, 14f)
                curveTo(10.343f, 14f, 9f, 12.657f, 9f, 11f)
...
private var _MessageSquareBlock: ImageVector? = null
