...
val VisibilityOff: ImageVector
    get() {
        if (_VisibilityOffSvgrepoCom != null) {
            return _VisibilityOffSvgrepoCom!!
        }
        _VisibilityOffSvgrepoCom = ImageVector.Builder(
            name = "VisibilityOffSvgrepoCom",
            defaultWidth = 800.dp,
...
private var _VisibilityOffSvgrepoCom: ImageVector? = null
