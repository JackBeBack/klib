...
val DazzleLine.MessageCircleBlock: ImageVector
    get() {
        if (_MessageCircleBlock != null) {
            return _MessageCircleBlock!!
        }
        _MessageCircleBlock = ImageVector.Builder(
            name = "MessageCircleBlock",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(9.877f, 14.119f)
                lineTo(14.124f, 9.882f)
                moveTo(15f, 12f)
...
private var _MessageCircleBlock: ImageVector? = null
