...
val DazzleLine.HouseBoltAlt: ImageVector
    get() {
        if (_HouseBoltAlt != null) {
            return _HouseBoltAlt!!
        }
        _HouseBoltAlt = ImageVector.Builder(
            name = "HouseBoltAlt",
            defaultWidth = 800.dp,
...
private var _HouseBoltAlt: ImageVector? = null
