...
val DazzleLine.MailOpenXmark: ImageVector
    get() {
        if (_MailOpenXmark != null) {
            return _MailOpenXmark!!
        }
        _MailOpenXmark = ImageVector.Builder(
            name = "MailOpenXmark",
            defaultWidth = 800.dp,
...
private var _MailOpenXmark: ImageVector? = null
