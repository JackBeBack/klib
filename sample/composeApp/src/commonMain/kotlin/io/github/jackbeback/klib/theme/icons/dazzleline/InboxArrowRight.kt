...
val DazzleLine.InboxArrowRight: ImageVector
    get() {
        if (_InboxArrowRight != null) {
            return _InboxArrowRight!!
        }
        _InboxArrowRight = ImageVector.Builder(
            name = "InboxArrowRight",
            defaultWidth = 800.dp,
...
private var _InboxArrowRight: ImageVector? = null
