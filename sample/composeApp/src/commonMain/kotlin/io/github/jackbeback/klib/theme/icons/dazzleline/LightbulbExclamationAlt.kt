...
val DazzleLine.LightbulbExclamationAlt: ImageVector
    get() {
        if (_LightbulbExclamationAlt != null) {
            return _LightbulbExclamationAlt!!
        }
        _LightbulbExclamationAlt = ImageVector.Builder(
            name = "LightbulbExclamationAlt",
            defaultWidth = 800.dp,
...
private var _LightbulbExclamationAlt: ImageVector? = null
