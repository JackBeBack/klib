...
val DazzleLine.FileBookmarkAlt: ImageVector
    get() {
        if (_FileBookmarkAlt != null) {
            return _FileBookmarkAlt!!
        }
        _FileBookmarkAlt = ImageVector.Builder(
            name = "FileBookmarkAlt",
            defaultWidth = 800.dp,
...
private var _FileBookmarkAlt: ImageVector? = null
