...
val DazzleLine.MonitorAlt: ImageVector
    get() {
        if (_MonitorAlt != null) {
            return _MonitorAlt!!
        }
        _MonitorAlt = ImageVector.Builder(
            name = "MonitorAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(7f, 21f)
                curveTo(7f, 21f, 8.5f, 20f, 12f, 20f)
                moveTo(12f, 20f)
                curveTo(15.5f, 20f, 17f, 21f, 17f, 21f)
                moveTo(12f, 20f)
                verticalLineTo(17f)
                moveTo(6.2f, 17f)
...
private var _MonitorAlt: ImageVector? = null
