...
val DazzleLine.CreditCardAlt: ImageVector
    get() {
        if (_CreditCardAlt != null) {
            return _CreditCardAlt!!
        }
        _CreditCardAlt = ImageVector.Builder(
            name = "CreditCardAlt",
            defaultWidth = 800.dp,
...
private var _CreditCardAlt: ImageVector? = null
