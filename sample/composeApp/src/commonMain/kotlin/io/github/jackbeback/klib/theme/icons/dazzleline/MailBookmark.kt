...
val DazzleLine.MailBookmark: ImageVector
    get() {
        if (_MailBookmark != null) {
            return _MailBookmark!!
        }
        _MailBookmark = ImageVector.Builder(
            name = "MailBookmark",
            defaultWidth = 800.dp,
...
private var _MailBookmark: ImageVector? = null
