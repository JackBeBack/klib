...
val DazzleLine.CreditCardArrowRight: ImageVector
    get() {
        if (_CreditCardArrowRight != null) {
            return _CreditCardArrowRight!!
        }
        _CreditCardArrowRight = ImageVector.Builder(
            name = "CreditCardArrowRight",
            defaultWidth = 800.dp,
...
private var _CreditCardArrowRight: ImageVector? = null
