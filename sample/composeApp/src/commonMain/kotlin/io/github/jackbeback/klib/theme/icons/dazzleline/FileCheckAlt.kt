...
val DazzleLine.FileCheckAlt: ImageVector
    get() {
        if (_FileCheckAlt != null) {
            return _FileCheckAlt!!
        }
        _FileCheckAlt = ImageVector.Builder(
            name = "FileCheckAlt",
            defaultWidth = 800.dp,
...
private var _FileCheckAlt: ImageVector? = null
