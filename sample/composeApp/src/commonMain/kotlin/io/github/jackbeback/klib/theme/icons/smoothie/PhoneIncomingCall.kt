...
val Smoothie.PhoneIncomingCall: ImageVector
    get() {
        if (_PhoneIncomingCall != null) {
            return _PhoneIncomingCall!!
        }
        _PhoneIncomingCall = ImageVector.Builder(
...
private var _PhoneIncomingCall: ImageVector? = null
