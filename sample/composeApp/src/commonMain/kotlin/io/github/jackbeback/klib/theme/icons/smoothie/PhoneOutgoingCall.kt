...
val Smoothie.PhoneOutgoingCall: ImageVector
    get() {
        if (_PhoneOutgoingCall != null) {
            return _PhoneOutgoingCall!!
        }
        _PhoneOutgoingCall = ImageVector.Builder(
            name = "PhoneOutgoingCall",
            defaultWidth = 800.dp,
...
private var _PhoneOutgoingCall: ImageVector? = null
