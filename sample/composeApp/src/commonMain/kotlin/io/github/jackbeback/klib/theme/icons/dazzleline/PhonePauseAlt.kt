...
val DazzleLine.PhonePauseAlt: ImageVector
    get() {
        if (_PhonePauseAlt != null) {
            return _PhonePauseAlt!!
        }
        _PhonePauseAlt = ImageVector.Builder(
            name = "PhonePauseAlt",
            defaultWidth = 800.dp,
...
private var _PhonePauseAlt: ImageVector? = null
