...
val DazzleLine.TrashUndoAlt: ImageVector
    get() {
        if (_TrashUndoAlt != null) {
            return _TrashUndoAlt!!
        }
        _TrashUndoAlt = ImageVector.Builder(
            name = "TrashUndoAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                curveTo(12.932f, 13f, 13.398f, 13f, 13.765f, 13.152f)
                curveTo(14.255f, 13.355f, 14.645f, 13.745f, 14.848f, 14.235f)
                curveTo(15f, 14.602f, 15f, 15.068f, 15f, 16f)
                moveTo(18f, 6f)
