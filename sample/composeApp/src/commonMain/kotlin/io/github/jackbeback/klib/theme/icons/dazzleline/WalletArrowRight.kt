...
val DazzleLine.WalletArrowRight: ImageVector
    get() {
        if (_WalletArrowRight != null) {
            return _WalletArrowRight!!
        }
        _WalletArrowRight = ImageVector.Builder(
...
private var _WalletArrowRight: ImageVector? = null
