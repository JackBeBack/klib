...
val DazzleLine.UserCheckAlt: ImageVector
    get() {
        if (_UserCheckAlt != null) {
            return _UserCheckAlt!!
        }
        _UserCheckAlt = ImageVector.Builder(
            name = "UserCheckAlt",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                lineTo(15.8f, 21f)
                lineTo(20f, 17f)
                moveTo(16.5f, 14.402f)
                curveTo(16.205f, 14.231f, 15.878f, 14.11f, 15.53f, 14.047f)
                curveTo(15.455f, 14.034f, 15.375f, 14.024f, 15.284f, 14.017f)
                curveTo(15.059f, 14f, 14.946f, 13.991f, 14.796f, 14.003f)
                curveTo(14.64f, 14.014f, 14.553f, 14.03f, 14.402f, 14.072f)
                curveTo(14.257f, 14.113f, 13.996f, 14.231f, 13.473f, 14.468f)
                curveTo(12.719f, 14.81f, 11.882f, 15f, 11f, 15f)
...
private var _UserCheckAlt: ImageVector? = null
