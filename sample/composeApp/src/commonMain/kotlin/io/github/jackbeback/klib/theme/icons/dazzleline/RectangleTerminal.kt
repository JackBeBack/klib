...
val DazzleLine.RectangleTerminal: ImageVector
    get() {
        if (_RectangleTerminal != null) {
            return _RectangleTerminal!!
        }
        _RectangleTerminal = ImageVector.Builder(
...
private var _RectangleTerminal: ImageVector? = null
