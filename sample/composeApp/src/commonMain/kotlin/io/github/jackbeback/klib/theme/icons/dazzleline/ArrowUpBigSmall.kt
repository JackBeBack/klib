...
val DazzleLine.ArrowUpBigSmall: ImageVector
    get() {
        if (_ArrowUpBigSmall != null) {
            return _ArrowUpBigSmall!!
        }
        _ArrowUpBigSmall = ImageVector.Builder(
            name = "ArrowUpBigSmall",
            defaultWidth = 800.dp,
...
private var _ArrowUpBigSmall: ImageVector? = null
