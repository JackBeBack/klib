...
val DazzleLine.MessageCircleLinesAlt: ImageVector
    get() {
        if (_MessageCircleLinesAlt != null) {
            return _MessageCircleLinesAlt!!
        }
        _MessageCircleLinesAlt = ImageVector.Builder(
            name = "MessageCircleLinesAlt",
            defaultWidth = 800.dp,
...
private var _MessageCircleLinesAlt: ImageVector? = null
