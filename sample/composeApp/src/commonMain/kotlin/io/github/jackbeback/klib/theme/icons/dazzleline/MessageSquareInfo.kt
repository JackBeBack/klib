...
val DazzleLine.MessageSquareInfo: ImageVector
    get() {
        if (_MessageSquareInfo != null) {
            return _MessageSquareInfo!!
        }
        _MessageSquareInfo = ImageVector.Builder(
            name = "MessageSquareInfo",
            defaultWidth = 800.dp,
...
private var _MessageSquareInfo: ImageVector? = null
