...
val DazzleLine.FileExclamationAlt: ImageVector
    get() {
        if (_FileExclamationAlt != null) {
            return _FileExclamationAlt!!
        }
        _FileExclamationAlt = ImageVector.Builder(
            name = "FileExclamationAlt",
            defaultWidth = 800.dp,
...
private var _FileExclamationAlt: ImageVector? = null
