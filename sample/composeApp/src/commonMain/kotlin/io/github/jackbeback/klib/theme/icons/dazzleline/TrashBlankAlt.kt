...
val DazzleLine.TrashBlankAlt: ImageVector
    get() {
        if (_TrashBlankAlt != null) {
            return _TrashBlankAlt!!
        }
        _TrashBlankAlt = ImageVector.Builder(
            name = "TrashBlankAlt",
            defaultWidth = 800.dp,
...
private var _TrashBlankAlt: ImageVector? = null
