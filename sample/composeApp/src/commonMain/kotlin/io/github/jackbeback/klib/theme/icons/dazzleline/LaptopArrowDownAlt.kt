...
val DazzleLine.LaptopArrowDownAlt: ImageVector
    get() {
        if (_LaptopArrowDownAlt != null) {
            return _LaptopArrowDownAlt!!
        }
        _LaptopArrowDownAlt = ImageVector.Builder(
            name = "LaptopArrowDownAlt",
            defaultWidth = 800.dp,
...
private var _LaptopArrowDownAlt: ImageVector? = null
