...
val DazzleLine.MonitorMedical: ImageVector
    get() {
        if (_MonitorMedical != null) {
            return _MonitorMedical!!
        }
        _MonitorMedical = ImageVector.Builder(
            name = "MonitorMedical",
            defaultWidth = 800.dp,
...
private var _MonitorMedical: ImageVector? = null
