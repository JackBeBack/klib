...
val Gentlecons.CalendarNew: ImageVector
    get() {
        if (_CalendarNew != null) {
            return _CalendarNew!!
        }
        _CalendarNew = ImageVector.Builder(
            name = "CalendarNew",
            defaultWidth = 800.dp,
            ...
            path(fill = SolidColor(Color(0xFF0F0F0F))) {
                ...
                curveTo(15.448f, 19f, 15f, 18.552f, 15f, 18f)
                curveTo(15f, 17.448f, 15.448f, 17f, 16f, 17f)
...
private var _CalendarNew: ImageVector? = null
