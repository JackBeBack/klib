...
val DazzleLine.FileArrowRight: ImageVector
    get() {
        if (_FileArrowRight != null) {
            return _FileArrowRight!!
        }
        _FileArrowRight = ImageVector.Builder(
            name = "FileArrowRight",
            defaultWidth = 800.dp,
...
private var _FileArrowRight: ImageVector? = null
