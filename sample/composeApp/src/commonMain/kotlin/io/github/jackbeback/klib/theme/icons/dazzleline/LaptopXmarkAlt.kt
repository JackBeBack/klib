...
val DazzleLine.LaptopXmarkAlt: ImageVector
    get() {
        if (_LaptopXmarkAlt != null) {
            return _LaptopXmarkAlt!!
        }
        _LaptopXmarkAlt = ImageVector.Builder(
            name = "LaptopXmarkAlt",
            defaultWidth = 800.dp,
...
private var _LaptopXmarkAlt: ImageVector? = null
