...
val DazzleLine.MailArrowDown: ImageVector
    get() {
        if (_MailArrowDown != null) {
            return _MailArrowDown!!
        }
        _MailArrowDown = ImageVector.Builder(
            name = "MailArrowDown",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                lineTo(15.55f, 11.633f)
                curveTo(14.267f, 12.489f, 13.625f, 12.916f, 12.932f, 13.082f)
                curveTo(12.319f, 13.229f, 11.68f, 13.229f, 11.068f, 13.082f)
                curveTo(10.374f, 12.916f, 9.733f, 12.489f, 8.45f, 11.633f)
                lineTo(3.147f, 8.098f)
            }
        }.build()
