...
val DazzleLine.LaptopSignalAlt: ImageVector
    get() {
        if (_LaptopSignalAlt != null) {
            return _LaptopSignalAlt!!
        }
        _LaptopSignalAlt = ImageVector.Builder(
            name = "LaptopSignalAlt",
            defaultWidth = 800.dp,
...
private var _LaptopSignalAlt: ImageVector? = null
