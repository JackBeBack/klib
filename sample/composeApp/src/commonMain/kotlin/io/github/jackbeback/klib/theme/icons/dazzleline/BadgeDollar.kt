...
val DazzleLine.BadgeDollar: ImageVector
    get() {
        if (_BadgeDollar != null) {
            return _BadgeDollar!!
        }
        _BadgeDollar = ImageVector.Builder(
            name = "BadgeDollar",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(12f, 9.376f)
                curveTo(11.193f, 9.401f, 10.002f, 9.737f, 10f, 10.687f)
                curveTo(9.998f, 11.7f, 11f, 12f, 12f, 12f)
                curveTo(13f, 12f, 14f, 12.231f, 14f, 13.312f)
                curveTo(14f, 14.125f, 13.006f, 14.481f, 12f, 14.599f)
                moveTo(12f, 9.376f)
                curveTo(12.685f, 9.371f, 13.5f, 9.376f, 14f, 9.5f)
                moveTo(12f, 9.376f)
                lineTo(12f, 8f)
                moveTo(12f, 14.599f)
                curveTo(11.2f, 14.599f, 11f, 14.625f, 10f, 14.5f)
                moveTo(12f, 14.599f)
                verticalLineTo(16f)
