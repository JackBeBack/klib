...
val DazzleLine.FolderQuestion: ImageVector
    get() {
        ...
        _FolderQuestion = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(11.937f, 13.75f)
                curveTo(12.937f, 12.75f, 13.937f, 12.355f, 13.937f, 11.25f)
                curveTo(13.937f, 10.145f, 13.042f, 9.25f, 11.937f, 9.25f)
                curveTo(11.005f, 9.25f, 10.222f, 9.887f, 10f, 10.75f)
                moveTo(11.937f, 16.25f)
                horizontalLineTo(11.947f)
