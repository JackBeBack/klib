...
val DazzleLine.FileMinusAlt: ImageVector
    get() {
        if (_FileMinusAlt != null) {
            return _FileMinusAlt!!
        }
        _FileMinusAlt = ImageVector.Builder(
            name = "FileMinusAlt",
            defaultWidth = 800.dp,
...
private var _FileMinusAlt: ImageVector? = null
