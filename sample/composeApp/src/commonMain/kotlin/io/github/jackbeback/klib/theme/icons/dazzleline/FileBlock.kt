...
val DazzleLine.FileBlock: ImageVector
    get() {
        if (_FileBlock != null) {
            return _FileBlock!!
        }
        _FileBlock = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(9.863f, 16.606f)
                lineTo(14.101f, 12.358f)
                moveTo(15f, 14.5f)
                curveTo(15f, 16.157f, 13.657f, 17.5f, 12f, 17.5f)
                curveTo(10.343f, 17.5f, 9f, 16.157f, 9f, 14.5f)
                curveTo(9f, 12.843f, 10.343f, 11.5f, 12f, 11.5f)
                curveTo(13.657f, 11.5f, 15f, 12.843f, 15f, 14.5f)
                close()
            }
        }.build()
