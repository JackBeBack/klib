...
val DazzleLine.MessageSquareDots: ImageVector
    get() {
        if (_MessageSquareDots != null) {
            return _MessageSquareDots!!
        }
        _MessageSquareDots = ImageVector.Builder(
...
private var _MessageSquareDots: ImageVector? = null
