...
val DazzleLine.PhonePlusAlt: ImageVector
    get() {
        if (_PhonePlusAlt != null) {
            return _PhonePlusAlt!!
        }
        _PhonePlusAlt = ImageVector.Builder(
            name = "PhonePlusAlt",
            defaultWidth = 800.dp,
...
private var _PhonePlusAlt: ImageVector? = null
