...
val DazzleLine.CalendarLinesAlt: ImageVector
    get() {
        if (_CalendarLinesAlt != null) {
            return _CalendarLinesAlt!!
        }
        _CalendarLinesAlt = ImageVector.Builder(
            name = "CalendarLinesAlt",
            defaultWidth = 800.dp,
...
private var _CalendarLinesAlt: ImageVector? = null
