...
val DazzleLine.FloppyDiskAlt: ImageVector
    get() {
        if (_FloppyDiskAlt != null) {
            return _FloppyDiskAlt!!
        }
        _FloppyDiskAlt = ImageVector.Builder(
            name = "FloppyDiskAlt",
            defaultWidth = 800.dp,
...
private var _FloppyDiskAlt: ImageVector? = null
