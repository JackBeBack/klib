...
val DazzleLine.FileChartColumn: ImageVector
    get() {
        if (_FileChartColumn != null) {
            return _FileChartColumn!!
        }
        _FileChartColumn = ImageVector.Builder(
...
private var _FileChartColumn: ImageVector? = null
