...
val DazzleLine.BatteryBoltAlt: ImageVector
    get() {
        if (_BatteryBoltAlt != null) {
            return _BatteryBoltAlt!!
        }
        _BatteryBoltAlt = ImageVector.Builder(
            name = "BatteryBoltAlt",
            defaultWidth = 800.dp,
...
private var _BatteryBoltAlt: ImageVector? = null
