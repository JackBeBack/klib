...
val DazzleLine.FolderUser: ImageVector
    get() {
        if (_FolderUser != null) {
            return _FolderUser!!
        }
        _FolderUser = ImageVector.Builder(
            name = "FolderUser",
            defaultWidth = 800.dp,
            ...
            path(
                ...
                moveTo(16f, 19f)
                curveTo(15.622f, 17.288f, 13.975f, 16f, 12f, 16f)
                curveTo(10.025f, 16f, 8.378f, 17.288f, 8f, 19f)
                moveTo(12f, 12f)
