...
val DazzleLine.LaptopArrowUpAlt: ImageVector
    get() {
        if (_LaptopArrowUpAlt != null) {
            return _LaptopArrowUpAlt!!
        }
        _LaptopArrowUpAlt = ImageVector.Builder(
            name = "LaptopArrowUpAlt",
            defaultWidth = 800.dp,
...
private var _LaptopArrowUpAlt: ImageVector? = null
