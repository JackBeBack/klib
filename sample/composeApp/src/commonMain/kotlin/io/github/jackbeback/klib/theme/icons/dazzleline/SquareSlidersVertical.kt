...
val DazzleLine.SquareSlidersVertical: ImageVector
    get() {
        if (_SquareSlidersVertical != null) {
            return _SquareSlidersVertical!!
        }
        _SquareSlidersVertical = ImageVector.Builder(
            name = "SquareSlidersVertical",
            defaultWidth = 800.dp,
...
private var _SquareSlidersVertical: ImageVector? = null
