...
val DazzleLine.PresentationChartAlt: ImageVector
    get() {
        if (_PresentationChartAlt != null) {
            return _PresentationChartAlt!!
        }
        _PresentationChartAlt = ImageVector.Builder(
            name = "PresentationChartAlt",
            defaultWidth = 800.dp,
...
private var _PresentationChartAlt: ImageVector? = null
