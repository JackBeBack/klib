...
val DazzleLine.LaptopSearchAlt: ImageVector
    get() {
        if (_LaptopSearchAlt != null) {
            return _LaptopSearchAlt!!
        }
        _LaptopSearchAlt = ImageVector.Builder(
            name = "LaptopSearchAlt",
            defaultWidth = 800.dp,
...
private var _LaptopSearchAlt: ImageVector? = null
