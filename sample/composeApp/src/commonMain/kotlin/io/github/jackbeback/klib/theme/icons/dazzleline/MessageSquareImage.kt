...
val DazzleLine.MessageSquareImage: ImageVector
    get() {
        if (_MessageSquareImage != null) {
            return _MessageSquareImage!!
        }
        _MessageSquareImage = ImageVector.Builder(
            name = "MessageSquareImage",
            defaultWidth = 800.dp,
...
private var _MessageSquareImage: ImageVector? = null
