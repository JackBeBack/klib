...
val DazzleLine.ClipboardTextAlt: ImageVector
    get() {
        if (_ClipboardTextAlt != null) {
            return _ClipboardTextAlt!!
        }
        _ClipboardTextAlt = ImageVector.Builder(
            name = "ClipboardTextAlt",
            defaultWidth = 800.dp,
...
private var _ClipboardTextAlt: ImageVector? = null
