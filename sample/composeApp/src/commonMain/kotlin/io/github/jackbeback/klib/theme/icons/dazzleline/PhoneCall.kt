...
val DazzleLine.PhoneCall: ImageVector
    get() {
        if (_PhoneCall != null) {
            return _PhoneCall!!
        }
        _PhoneCall = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(14.05f, 6f)
                curveTo(15.027f, 6.191f, 15.924f, 6.668f, 16.628f, 7.372f)
                curveTo(17.332f, 8.076f, 17.809f, 8.973f, 18f, 9.95f)
                moveTo(14.05f, 2f)
                curveTo(16.079f, 2.225f, 17.972f, 3.134f, 19.416f, 4.577f)
                curveTo(20.861f, 6.02f, 21.772f, 7.911f, 22f, 9.94f)
                moveTo(18.5f, 21f)
