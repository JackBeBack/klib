...
val DazzleLine.MessageSquareArrowDown: ImageVector
    get() {
        if (_MessageSquareArrowDown != null) {
            return _MessageSquareArrowDown!!
        }
        _MessageSquareArrowDown = ImageVector.Builder(
            name = "MessageSquareArrowDown",
            defaultWidth = 800.dp,
...
private var _MessageSquareArrowDown: ImageVector? = null
