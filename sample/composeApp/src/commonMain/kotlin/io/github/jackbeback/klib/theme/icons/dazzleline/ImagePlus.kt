...
val DazzleLine.ImagePlus: ImageVector
    get() {
        if (_ImagePlus != null) {
            return _ImagePlus!!
        }
        _ImagePlus = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(18.22f, 19.963f)
                curveTo(17.87f, 20f, 17.421f, 20f, 16.8f, 20f)
                horizontalLineTo(7.2f)
                curveTo(6.08f, 20f, 5.52f, 20f, 5.092f, 19.782f)
                curveTo(4.716f, 19.59f, 4.41f, 19.284f, 4.218f, 18.908f)
                curveTo(4.126f, 18.727f, 4.073f, 18.523f, 4.042f, 18.262f)
                moveTo(18.22f, 19.963f)
                curveTo(18.501f, 19.933f, 18.718f, 19.879f, 18.908f, 19.782f)
