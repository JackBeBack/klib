...
val DazzleLine.SquareMedical: ImageVector
    get() {
        if (_SquareMedical != null) {
            return _SquareMedical!!
        }
        _SquareMedical = ImageVector.Builder(
            name = "SquareMedical",
            defaultWidth = 800.dp,
...
private var _SquareMedical: ImageVector? = null
